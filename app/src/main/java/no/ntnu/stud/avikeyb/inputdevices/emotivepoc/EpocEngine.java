...
public class EpocEngine {
    ...
    private void detectAction() {
        ...
        } else if (action == IEmoStateDLL.IEE_MentalCommandAction_t.MC_LEFT.ToInt()) { //MC_PUSH
        ...
        } else if (action == IEmoStateDLL.IEE_MentalCommandAction_t.MC_PUSH.ToInt()) { //MC_LEFT
    ...
    private void fireActionIfStrong(Action action) {
        ...
        System.out.printf("The power is: " + power + ", The Action is:" + action);
        if (action == Action.NEUTRAL || (power > 0.2f && mCurrentAction != action)) {
